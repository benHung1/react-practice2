			...
			<Container>
				<Row justify="center">
					<LeftColumn width="50%">
						...
						<Video
							width="70%"
							src="https://vod-progressive.akamaized.net/exp=1642683870~acl=%2Fvimeo-prod-skyfire-std-us%2F01%2F3692%2F14%2F368460590%2F1524863258.mp4~hmac=d71ffc059c8630d649c71c4b5403f2398727499981e9cb71733307ee9ace5bce/vimeo-prod-skyfire-std-us/01/3692/14/368460590/1524863258.mp4?filename=video.mp4"
							type="video/mp4"
							autoPlay
							muted
							loop
						...
						<Features>
							<div>
								<img className="lock" src="https://i.imgur.com/BU03lBF.png" alt="21" />
								<Text bold>Safest Platform</Text>
								<a href="localhost:3000">Find out why</a>
							</div>
							<div>
								<img className="reviews" src="https://i.imgur.com/df3e52z.png" alt="21" />
